...
public class PrivacyActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setToolbarAsUp(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ActivityCompat.finishAfterTransition(PrivacyActivity.this);
            }
        });
        ...
        mWebView = (WebView) findViewById(R.id.privacy_web);
        ...
        mWebView.loadUrl(AccountDetailConstant.POLICY_LINK);
    ...
    public static void startPrivacyActivity(final Activity activity) {
