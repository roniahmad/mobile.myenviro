...
import static com.rsbunda.myenviro.util.PreconditionUtils.checkNotNull;

//import com.orcalab.myenviro.session.SessionDetailModel;

/**
 * Implementation class for {@link Model}, using the {@link LoaderManager} callbacks to query the
 * data from the {@link com.rsbunda.myenviro.provider.ScheduleProvider}.
 */
public abstract class ModelWithLoaderManager<Q extends QueryEnum, UA extends UserActionEnum>
     ...
     * {@link com.rsbunda.myenviro.archframework.Model.DataQueryCallback} to the {@link
