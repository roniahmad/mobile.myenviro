...
public class DividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDraw(Canvas canvas, RecyclerView rv, RecyclerView.State state) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            boolean needsDivider = holder instanceof DividerDecoration.Divided;
    ...
    /**
     * Empty marker interface, used to denote a {@link RecyclerView.ViewHolder} as requiring a divider.
     */
